package com.targinou.productapi.security.jwt;
...
public class JwtService {
    ...
    private final int EXPIRATION_TIME = 1000 * 60 * 5;
    ...
    public AuthenticationResponse generateToken(UserDetails userDetails, long userId) {
        Map<String, Object> extraClaims = new HashMap<>();
        extraClaims.put("id", String.valueOf(userId));
        extraClaims.put(
                "role",
